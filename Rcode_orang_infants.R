...
test.data <- read.table(paste0(path,"data_orang_infants.csv"), header=TRUE, sep=",")
infant.age.dat <- read.xlsx(xlsxFile=paste0(path,"orang_infant_ages.xlsx"), sheet=1, colNames=FALSE) ; colnames(infant.age.dat) <- c("animal_id","ageYears")
